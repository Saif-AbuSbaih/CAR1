                ...
                <div class="col-lg-9">
                    ...
                    <div class="car__details__tab">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab"> مواصفات السيارة </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab">تقرير الفحص</a>
                            </li>
                ...
                <div class="col-lg-3">
                    <div class="car__details__sidebar">
                        <div class="car__details__sidebar__model">
                          ...
                          <p>التاريخ 11/26/2019</p>
                            <ul>
                                <li>رقم الشصي <span>K99D10459934</span></li>
                                <li>المسافة المقطوعة <span>00000000 كم</span></li>
                                <li>المحرك <span>بنزين</span></li>
                                <li>ناقل الحركة  <span>اوتوماتيك</span></li>
                        ...
                        <div class="car__details__sidebar__payment">
                            <ul>
                                <li>تكلفة التصليح المتوقعة <span>$120,000</span></li>
                                <li>تكلفة الشحن <span>$3,000</span></li>
                                <li>السعر <span>$117,000</span></li>
                            </ul>
                            <a href="#" class="primary-btn"><i class="fa fa-credit-card"></i> اشتري الان</a>
